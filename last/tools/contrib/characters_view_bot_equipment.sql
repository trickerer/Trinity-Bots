...
INNER JOIN trinity.creature_template ON creature_template.entry = npcbot.entry
...
left JOIN trinity.item_template MhEx_n ON MhEx_n.entry = mhex.itementry
left JOIN characters.item_instance OhEx ON OhEx.guid = npcbot.equipOhEx
left JOIN trinity.item_template OhEx_n ON OhEx_n.entry = OhEx.itementry
left JOIN characters.item_instance RhEx ON RhEx.guid = npcbot.equipRhEx
left JOIN trinity.item_template RhEx_n ON RhEx_n.entry = RhEx.itementry
left JOIN characters.item_instance Head ON Head.guid = npcbot.equipHead
left JOIN trinity.item_template Head_n ON Head_n.entry = Head.itementry
left JOIN characters.item_instance Shoulders ON Shoulders.guid = npcbot.equipShoulders
left JOIN trinity.item_template Shoulders_n ON Shoulders_n.entry = Shoulders.itementry
left JOIN characters.item_instance Chest ON Chest.guid = npcbot.equipChest
left JOIN trinity.item_template Chest_n ON Chest_n.entry = Chest.itementry
left JOIN characters.item_instance Waist ON Waist.guid = npcbot.equipWaist
left JOIN trinity.item_template Waist_n ON Waist_n.entry = Waist.itementry
left JOIN characters.item_instance Legs ON Legs.guid = npcbot.equipLegs
left JOIN trinity.item_template Legs_n ON Legs_n.entry = Legs.itementry
left JOIN characters.item_instance Feet ON Feet.guid = npcbot.equipFeet
left JOIN trinity.item_template Feet_n ON Feet_n.entry = Feet.itementry
left JOIN characters.item_instance Wrist ON Wrist.guid = npcbot.equipWrist
left JOIN trinity.item_template Wrist_n ON Wrist_n.entry = Wrist.itementry
left JOIN characters.item_instance Hands ON Hands.guid = npcbot.equipHands
left JOIN trinity.item_template Hands_n ON Hands_n.entry = Hands.itementry
left JOIN characters.item_instance Back ON Back.guid = npcbot.equipBack
left JOIN trinity.item_template Back_n ON Back_n.entry = Back.itementry
left JOIN characters.item_instance Body ON Body.guid = npcbot.equipBody
left JOIN trinity.item_template Body_n ON Body_n.entry = Body.itementry
left JOIN characters.item_instance Finger1 ON Finger1.guid = npcbot.equipFinger1
left JOIN trinity.item_template Finger1_n ON Finger1_n.entry = Finger1.itementry
left JOIN characters.item_instance Finger2 ON Finger2.guid = npcbot.equipFinger2
left JOIN trinity.item_template Finger2_n ON Finger2_n.entry = Finger2.itementry
left JOIN characters.item_instance Trinket1 ON Trinket1.guid = npcbot.equipTrinket1
left JOIN trinity.item_template Trinket1_n ON Trinket1_n.entry = Trinket1.itementry
left JOIN characters.item_instance Trinket2 ON Trinket2.guid = npcbot.equipTrinket2
left JOIN trinity.item_template Trinket2_n ON Trinket2_n.entry = Trinket2.itementry
left JOIN characters.item_instance Neck ON Neck.guid = npcbot.equipNeck
left JOIN trinity.item_template Neck_n ON Neck_n.entry = Neck.itementry
